...
{
    app.setStyleSheet("QWidget        { background: rgb(24,26,30); }"
                      "QFrame         { border: none; }"
                      ...
                      "QComboBox QAbstractItemView::item:hover { background: rgb(24,26,30); color: rgb(255,255,255); }"
                      ...
                      "QMenuBar       { background: rgb(24,26,30); color: rgb(110,116,126); }"
                      ...
                      "QTabBar::tab:hover  { color: #FFFFFF; border: 2px solid #e2bd79; border-bottom-color: #e2bd79; }"
                      "QTabBar::tab:!hover  { color: rgb(120,127,139); border: 1px solid rgb(78,79,83); border-bottom: none; padding: 5px; }"
                      "QTabBar::tab:selected  { color: #FFFFFF; background: rgb(120,127,139); border: 2px solid rgb(226,189,121); border-bottom: none; }"
                      "QTabBar::tab:!selected { background: rgb(24,26,30); margin-top: 2px; }"
                      "QTabWidget::pane { border: 1px solid rgb(78,79,83); }"
                      "QToolButton    { background: rgb(24,26,30); color: rgb(116,122,134); border: none; border-left-color: rgb(30,32,36); border-left-style: solid; border-left-width: 6px; margin-top: 8px; margin-bottom: 8px; }"
                      ...
                      "QHeaderView::section { background: rgb(24,26,30); color: rgb(255,255,255); }"
