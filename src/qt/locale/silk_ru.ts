...
<context>
    ...
    <message>
        ...
        <translation>Это ваши адреса Silk для отправки платежей. Всегда проверяйте количество и адрес получателя перед отправкой перевода.</translation>
    </message>
    <message>
        ...
        <translation>Это ваши адреса Silk для приёма платежей. Рекомендуется использовать новый адрес получения для каждой транзакции.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Silk Core клиент</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Показать информацию о Silk Core</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Подписать сообщения вашим адресом Silk, чтобы доказать, что вы им владеете</translation>
    </message>
    <message>
        <source>Verify messages to ensure they were signed with specified Silk addresses</source>
        <translation>Проверить сообщения, чтобы удостовериться, что они были подписаны определённым адресом Silk</translation>
    </message>
    <message>
        <source>&amp;File</source>
    ...
    <message>
        ...
        <translation>Запросить платежи (создаёт QR-коды и Silk: ссылки)</translation>
    </message>
    <message>
        <source>&amp;About Silk Core</source>
        <translation>&amp;О Silk Core</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Открыть Silk: URI или запрос платежа</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Показать помощь по Silk Core и получить список доступных параметров командной строки.</translation>
    </message>
    <message numerus="yes">
        <source>%n active connection(s) to Silk network</source>
        <translation><numerusform>%n активное соединение с сетью</numerusform><numerusform>%n активных соединений с сетью</numerusform><numerusform>%n активных соединений с сетью Silk</numerusform><numerusform>%n активных соединений с сетью Silk</numerusform></translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Добро пожаловать в Silk Core.</translation>
    </message>
    <message>
        <source>As this is the first time the program is launched, you can choose where Silk Core will store its data.</source>
        <translation>Так как вы впервые запустили программу, вы можете выбрать, где Silk Core будет хранить данные.</translation>
    </message>
    <message>
        ...
        <translation>Silk Core скачает и сохранит копию цепи блоков. Как минимум, %1ГБ данных будет храниться в этом каталоге, и со временем он будет расти. Бумажник будет также сохранён в этом каталоге.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Подключаться к сети Silk через прокси SOCKS5</translation>
    </message>
    <message>
        <source>&amp;Connect through SOCKS5 proxy (default proxy):</source>
        <translation>&amp;Подключаться к сети Silk через прокси SOCKS5 (прокси по умолчанию):</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Не удаётся запустить Silk: обработчик click-to-pay</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Введите адрес Silk (например, %1)</translation>
    </message>
    <message>
        <source>Enter a Silk address or name registered on the dDNS.</source>
        <translation>Введите адрес Silk или имя, зарегистрированное на dDNS.</translation>
    </message>
    <message>
        <source>%1 d</source>
...
<context>
    ...
    <message>
        ...
        <translation>Необязательное сообщение для запроса платежа, которое будет показано при открытии запроса. Заметьте: сообщение не будет отправлено вместе с платежом через сеть Silk.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Внимание: неверный адрес Silk</translation>
    </message>
    <message>
        <source>(no label)</source>
        <translation>[нет метки]</translation>
...
<context>
    ...
    <message>
        ...
        <translation>Адрес Silk, на который отправить платёж</translation>
    </message>
    <message>
        <source>Alt+A</source>
    ...
    <message>
        ...
        <translation>К Silk: URI было прикреплено сообщение, которое будет сохранено вместе с транзакцией для вашего сведения. Заметьте: сообщение не будет отправлено через сеть Silk.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Silk Core выключается...</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Адрес Silk, которым подписать сообщение</translation>
    </message>
    <message>
        <source>Choose previously used address</source>
        <translation>Выберите ранее использованный адрес</translation>
    ...
    <message>
        ...
        <translation>Адрес Silk, которым было подписано сообщение</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Разработчики Silk Core</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Не удалось забиндиться на %s на этом компьютере. Возможно, Silk Core уже запущен.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Не удалось установить блокировку на каталог данных %s. Возможно, Silk Core уже запущен.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Комиссии (в SLK/Кб) меньшие этого значения считаются нулевыми для трансляции (по умолчанию: %s)</translation>
    </message>
    <message>
        <source>Fees (in SLK/Kb) smaller than this are considered zero fee for transaction creation (default: %s)</source>
        <translation>Комиссии (в SLK/Кб) меньшие этого значения считаются нулевыми для создания транзакции (по умолчанию: %s)</translation>
    </message>
    <message>
...
for example: alertnotify=echo %%s | mail -s "Silk Alert" admin@foo.com
        ...
        <translation>Для использования silkd или опции silk-qt -server, вы должны установить опцию rpcpassword в конфигурационном файле:
 %s
...
Например: alertnotify=echo %%s | mail -s "Silk Alert" admin@foo.com
</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Внимание: убедитесь, что дата и время на Вашем компьютере выставлены верно. Если Ваши часы идут неправильно, Silk Core будет работать некорректно.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Все права защищены © 2013-%i Разработчики Silk Core</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Ошибка загрузки wallet.dat: бумажник требует более новую версию Silk Core</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Комиссия (в SLK/Кб) для добавления к вашим транзакциям (по умолчанию: %s)</translation>
    </message>
    <message>
        <source>Information</source>
        <translation>Информация</translation>
    ...
    <message>
        ...
        <translation>Не удалось проверить чистоту. Silk Core выключается.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Параметры RPC SSL: (см. Silk вики для инструкций по настройке SSL)</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Необходимо перезаписать бумажник, перезапустите Silk Core для завершения операции.</translation>
    </message>
    <message>
        <source>Warning</source>
        <translation>Внимание</translation>
