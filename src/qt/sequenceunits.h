...
#ifndef SEQUENCE_QT_SEQUENCEUNITS_H
#define SEQUENCE_QT_SEQUENCEUNITS_H
...
/** sequence unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class SequenceUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit SequenceUnits(QObject *parent);

    /** Sequence units.
      @note Source: https://en.sequence.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        SEQ,
...
typedef SequenceUnits::Unit SequenceUnit;
