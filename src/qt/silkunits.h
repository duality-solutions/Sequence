...
#ifndef SILK_QT_SILKUNITS_H
#define SILK_QT_SILKUNITS_H
...
/** silk unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class SilkUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit SilkUnits(QObject *parent);

    /** Silk units.
      @note Source: https://en.silk.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        SLK,
...
typedef SilkUnits::Unit SilkUnit;

#endif // SILK_QT_SILKUNITS_H
