...
Note
---------------------
Always use absolute paths to configure and compile silk and the dependencies,a
...
Build requirements:
    ...
    sudo apt-get install git build-essential libtool autotools-dev autoconf pkg-config libssl-dev
