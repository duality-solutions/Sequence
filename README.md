...
The Sequence(SEQ) blockchain exists in the Duality binary architecture for [Dynamic(DYN)](https://github.com/duality-solutions/dynamic) is its real world interface.
